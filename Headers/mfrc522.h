...
sbit MFRC522_CS at RD7_Bit; // SDA
sbit MFRC522_Rst at RD3_Bit; // RST
sbit SoftSPI_SDO at RD5_Bit;  // MOSI
sbit SoftSPI_CLK at RD6_Bit;   // SCK
sbit SoftSPI_SDI at RD4_Bit;   // MISO
sbit MFRC522_CS_Direction at TRISD7_Bit;
...
void MFRC522_Init()
{
     ...
     MFRC522_Wr( MODEREG, 0x3D );      // CRC initial value of 0x6363
...
char i, n;
 ...
 //Writes data in FIFO
    ...
    i = 0xFF;
    //Waiting for finalization of CRC Calculation
    do
    {
